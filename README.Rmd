...
MF.CSEM(half1 = dhalf1, half2 = dhalf2, data = dataset, reliability.coef = 0.9, n.items = 6, min.score.item = 0, max.score.item = 4, conf.level = .95)

## Example: Computing Thorndike-CSEM {#sec-example-computing-thorndike-csem}
